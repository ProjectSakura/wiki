      ...
      {!loading && (
        <center>
          <div className="content">
            ...
            <p>To flash ProjectSakura you will need to get the flashable ROM zip for your device. We have a download center where you can get builds for every device that we support, Go to  <a href="https://ProjectSakura.xyz/download" target="_blank" rel="noreferrer">ProjectSakura | Downloads</a>
              <br /><br />
